...
const REQUIRED_PERMISSIONS: [(&str, &str, &str, &str, bool); 11] = [
    ...
    ("pricing.override_below_cost", "catalog", "تجاوز البيع تحت التكلفة", "Autoriser la vente sous le coût", true),
...
fn execute_setup_transaction(
    ...
    transaction.execute(
        ...
        INSERT INTO company_settings (
            ...
            below_cost_policy, session_idle_timeout_minutes, created_at, created_by,
        ...
        params![
            ...
            request.below_cost_policy.as_deref().unwrap_or("ADMIN_OVERRIDE"),
