...
pub const PERMISSIONS: &[(&str, &str, &str, bool)] = &[
    ("perm-p09-doc-tpl-view", "documents.templates.view", "documents", false),
    ("perm-p09-doc-tpl-manage", "documents.templates.manage", "documents", true),
    ("perm-p09-doc-render", "documents.render", "documents", false),
    ("perm-p09-doc-print", "documents.print", "documents", false),
    ("perm-p09-doc-export", "documents.export", "documents", false),
    ("perm-p09-reports-view", "reports.view", "reports", false),
    ("perm-p09-reports-export", "reports.export", "reports", false),
...
fn grant(transaction: &Transaction<'_>, role: &str, permission: &str, now: &str) -> Phase09Result<()> {
    transaction.execute(
