...
INSERT OR IGNORE INTO permissions (
    ...
    ('perm-stock-count', 'stock.count', 'inventory', 'إدارة الجرد الفعلي', 'Gérer les inventaires physiques', 1, '2026-07-28T00:00:00Z'),
    ('perm-stock-reservation-manage', 'stock.reservation.manage', 'inventory', 'إدارة حجوزات المخزون', 'Gérer les réservations de stock', 0, '2026-07-28T00:00:00Z'),
    ('perm-stock-reconcile', 'stock.reconcile', 'inventory', 'مطابقة وإعادة بناء المخزون', 'Rapprocher et reconstruire le stock', 1, '2026-07-28T00:00:00Z'),
    ('perm-stock-negative-override', 'stock.negative.override', 'inventory', 'تجاوز المخزون السالب', 'Autoriser le stock négatif', 1, '2026-07-28T00:00:00Z'),
    ...
    ('perm-purchase-return-post', 'purchase_return.post', 'purchases', 'ترحيل مرتجع مشتريات', 'Valider un retour fournisseur', 1, '2026-07-28T00:00:00Z'),
...
INSERT OR IGNORE INTO role_permissions (id, company_id, role_id, permission_id, granted_at, granted_by) VALUES
    ...
    ('rp-stock-count', NULL, 'role-stock', 'perm-stock-count', '2026-07-28T00:00:00Z', NULL),
    ('rp-stock-reservation-manage', NULL, 'role-stock', 'perm-stock-reservation-manage', '2026-07-28T00:00:00Z', NULL),
    ('rp-stock-reconcile', NULL, 'role-stock', 'perm-stock-reconcile', '2026-07-28T00:00:00Z', NULL),
    ...
    ('rp-purchasing-return-post', NULL, 'role-purchasing', 'perm-purchase-return-post', '2026-07-28T00:00:00Z', NULL),
    ('rp-purchasing-stock-read', NULL, 'role-purchasing', 'perm-stock-read', '2026-07-28T00:00:00Z', NULL),
